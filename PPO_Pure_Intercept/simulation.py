...
if __name__ == "__main__":
    ...
    policy_kwargs = dict(
        ...
        features_extractor_kwargs=dict(embed_dim=32, num_heads=8, ff_hidden=32*4, num_layers=4, seq_len=3),
    ...
    model = PPO(
        ...
        #ent_coef=0.05,
        tensorboard_log= absolute_parent_dir+ "/LMA_Pure_Intercept/ppo_lma_tensorboard/"
    )
